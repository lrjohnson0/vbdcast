...
pdf("pit_iquitos.pdf", width=14, height=5)
par(mfrow=c(1,3), mar=c(2,5,1,1))
hist(pit$pi.nopast, xlab="", ylab="peak incidence - hetGP", cex.lab=2, main="", ylim=c(0,60))
hist(pit$pw.nopast, xlab="", ylab="peak week - hetGP", cex.lab=2, main="", ylim=c(0,60))
hist(pit$ti.nopast, xlab="", ylab="total incidence - hetGP", cex.lab=2, main="", ylim=c(0,60))
dev.off()
